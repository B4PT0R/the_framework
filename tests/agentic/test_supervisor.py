...
from the_framework.server.runtime.supervisor import WorkerExited, WorkerSupervisor, WorkerTransportError
...
def test_supervisor_defaults_to_the_generic_agent_worker(tmp_path):
    ...
    assert supervisor.command[1:3] == ["-m", "the_framework.agent.runtime.worker_process"]
