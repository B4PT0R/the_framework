...
from harness_core.agent import AgentResult, Message, Plugin, agent_trigger
...
from harness_core.plugins.memory.store import MemoryStore, format_memories_xml, rank_memories
...
class MemoryPlugin(Plugin):
    ...
    @agent_trigger(
        AgentSpec(
            ...
            plugins=["harness_core.plugins.memory.curator:MemoryCuratorPlugin"],
